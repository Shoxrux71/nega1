      ...
      <div className="flex-grow p-8 grid gap-8 grid-cols-1 md:grid-cols-2">
        <div className="border border-gray-300 bg-white text-gray-900 p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mb-4">
            <span className="text-blue-600">&quot;自動詞&quot; (jidōshi)</span> oz-ozidan harakat qiluvchi feʻllarni anglatadi, masalan, &quot;ochilmoq&quot; yoki &quot;qaytmoq&quot;.
          </p>
          <div className="space-y-2">
            ...
            <AccordionItem title="車が止まる (Kuruma ga tomaru)" content="Mashina toʻxtaydi." />
            ...
            <AccordionItem title="雨が降る (Ame ga furu)" content="Yomgʻir yogʻadi." />
        ...
        <div className="border border-gray-300 bg-white text-gray-900 p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mb-4">
            <span className="text-blue-600">&quot;他動詞&quot; (tadōshi)</span> esa boshqalarni harakatga keltiruvchi feʻllarni anglatadi, masalan, &quot;ochmoq&quot; yoki &quot;qaytarish&quot;.
          </p>
          <div className="space-y-2">
            <AccordionItem title="ドアを開ける (Doa o akeru)" content="Eshikni ochmoq." />
            <AccordionItem title="電気を消す (Denki o kesu)" content="Chiroqni oʻchirmoq." />
            <AccordionItem title="花を植える (Hana o ueru)" content="Gul ekmoq." />
            <AccordionItem title="車を止める (Kuruma o tomeru)" content="Mashinani toʻxtatmoq." />
            ...
            <AccordionItem title="雨を降らせる (Ame o furaseru)" content="Yomgʻir yogʻdirmoq." />
            <AccordionItem title="電車を出す (Densha o dasu)" content="Poyezdni chiqarish." />
            <AccordionItem title="火を消す (Hi o kesu)" content="Olovni oʻchirmoq." />
          </div>
        </div>
      </div>
      <Footer />
