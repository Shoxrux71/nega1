      ...
      <div className="flex-grow p-8 grid gap-8 grid-cols-1 md:grid-cols-2">
        <div className="border border-gray-300 bg-white text-gray-900 p-6 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold mb-4">
            <span className="text-blue-600">"自動詞" (jid`shi)</span>
          </h1>
          ...
          <div className="space-y-2">
            ...
            <AccordionItem title="車が止まる (Kuruma ga tomaru)" content="Mashina toxtaydi." />
        ...
        <div className="border border-gray-300 bg-white text-gray-900 p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-2">
            ...
            <AccordionItem title="電気を消す (Denki o kesu)" content="Chiroqni ochirmoq." />
            <AccordionItem title="花を植える (Hana o ueru)" content="Gul ekmoq." />
            <AccordionItem title="車を止める (Kuruma o tomeru)" content="Mashinani toxtatmoq." />
            ...
            <AccordionItem title="火を消す (Hi o kesu)" content="Olovni ochirmoq." />
          </div>
        </div>
      </div>
      <Footer />
